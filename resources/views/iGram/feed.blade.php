                                        ...
                                        @foreach ($followedUser->posts as $post)
                                                <div class="card my-3" style="width: 630px">
                                                        ...
                                                        <div class="card-body">
                                                                ...
                                                                <div>
                                                                        <a href="{{ route('post.view', $post->id) }}" class="text-decoration-none"><p>View all <span>{{ $post->comments->count() }}</span> comments</p></a>
                                                                </div>
                                                                <div class="">
                                                        ...
                                                        <div class="card-footer bg-white">
                                                                <form class="form-inline my-2 my-lg-0" onsubmit="comment({{ $post->id}}, {{ auth()->user()->id }})">
                                                                        <input class="form-control mr-sm-2" type="search" id="commentPost" placeholder="Add a comment..." aria-label="Search">
                                                                </form>
                                                        </div>
                                                </div> 
                                        @endforeach
